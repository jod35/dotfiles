...
5. [rofi config](./rofi/config.rasi)
6. [picom config](./picom/picom.conf)
7. [fish config](./fish/config.fish)
8. [set up script](./setup.sh)
9. [Config update script](./update-conf.sh)
